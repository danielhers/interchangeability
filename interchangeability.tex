...
\begin{document}
    ...
    We train 300-dimensional word2vec \cite{mikolov2013efficient} models,
    using the fastText implementation \cite{bojanowski2016enriching}.
    We train models using a context window size of 1 up to 15,
